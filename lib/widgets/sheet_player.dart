      ...
      child: AnimatedContainer(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: Padding(
                ...
                child: Image.network(
                  ...
                  // Full-player art fills the width; decode near that rather than
                  // at the artwork's native resolution.
                  cacheWidth: context.cachePx(500),
                ),
              ),
            ),
                  ...
                  GestureDetector(
                    ...
                    child: Stack(
                      children: [
                        ...
                        if (audioState.index >= 0 &&
                            audioState.index <
                                audioState.trackIdHistory.length &&
                            audioState
                                .trackIdHistory[audioState.index]
                                .isNotEmpty &&
                            !audioState.isLoading)
            ...
            // Lyrics and the queue, side by side.
            SafeArea(
              top: false,
              child: Row(
                children: [
...
/// A labelled icon button for the row at the bottom of the full player.
